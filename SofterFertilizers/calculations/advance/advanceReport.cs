...
{
    public partial class advanceReport : UserControl
    {
        ...
        void fill()
        {
            ...
            conDataBase.Open();
            string Query = "select distinct Id from advancesMainTable;";
