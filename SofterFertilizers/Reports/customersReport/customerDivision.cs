...
{
    public partial class customerDivision : UserControl
    {
        ...
        private void showFlowButton_Click(object sender, EventArgs e)
        {
            ...
            string Query = "select debtsmainTable.billNumber as 'رقم الفاتورة', debtsTable.debtorder as'رقم القسط', debtsTable.debtAmount as 'قيمة القسط', debtsTable.debtDate as 'معاد الدفع',debtsTable.paidAmount as 'القيمة المسددة' from debtsMainTable,debtsTable,salesMainTable where debtsMainTable.billNumber = salesMainTable.Id and debtsMainTable.Id = debtsTable.debtMainTableNumber and salesMainTable.customerName = N'"+this.customerNameComboBox.Text+"' and debtsTable.status = 'False'";
            SqlConnection conDataBase = new SqlConnection(constring);
