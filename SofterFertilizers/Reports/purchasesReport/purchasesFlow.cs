...
{
    public partial class purchasesFlow : UserControl
    {
        public purchasesFlow()
        {
            InitializeComponent();
            fill();
