...
namespace SofterFertilizers.Reports.storeReports
{
    public partial class storeCategoryReport : UserControl
    {
        ...
        {
            string Query = "select distinct categoryQuantityTable.categoryNumber as 'كود الصنف', categoryTable.categoryName as 'اسم الصنف', categoryTable.mainUnit as 'الوحدة', categoryTable.mainType as 'النوع', categoryTable.storeCode as 'الكود المخزني',categoryQuantityTable.Quantity as 'الكمية'  from categoryQuantityTable,categoryTable where categoryQuantityTable.categoryNumber =categoryTable.Id and categoryQuantityTable.storeName =N'" + this.storeNameComboBox.Text + "';";
